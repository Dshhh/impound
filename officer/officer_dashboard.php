                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open">
                            <a href="officer_dashboard.php" class="nav-link active"><i class="nav-icon fas fa-address-card"></i><p>Profile</p></a>
                        </li>
                        <li class="nav-item">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($recent_records as $record): ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars(date ('F j, Y', strtotime($record['impound_date'])));  ?></td>
                                                <td><?php echo htmlspecialchars($record['vehicle_type']); ?></td>
                                                <td><?php echo htmlspecialchars($record['officer_id']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
