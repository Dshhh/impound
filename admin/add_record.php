...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // Insert into `riders`
        $stmt = $conn->prepare("INSERT INTO riders (rider_first_name, rider_middle_name, rider_last_name, rider_age, rider_gender, rider_address, license_number) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssss", $rider_first_name, $rider_middle_name, $rider_last_name, $rider_age, $rider_gender, $rider_address, $license_number);        
        $stmt->execute();
